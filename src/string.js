...
export const 𝘍endsWith = (end, x) => endsWithLength(end, x.length, x)
...
export const 𝘍indexOf = (toSearch, x) => indexOfFromIndex(toSearch, 0, x)
export const indexOf = curry(𝘍indexOf)
export const lastIndexOfFromIndex = e2(`lastIndexOf`)
// samesies
export const 𝘍lastIndexOf = (toSearch, x) => lastIndexOfFromIndex(toSearch, Infinity, x)
...
export const 𝘍startsWith = (toSearch, x) => startsWithFromPosition(toSearch, 0, x)
